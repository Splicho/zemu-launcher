 ...
 * we don't pull in a full icon pack — these are the icons the
 * launcher auth flow supports.
 *
 ...
 * Icons render at any size via the `size` prop.
 */
...
interface IconProps extends React.SVGAttributes<SVGSVGElement> {
   ...
   *
   * Most callers leave this unset and size the icon via the surrounding
   * text-size CSS (the SVGs default to `1em` so they scale with the
   * parent). When `size` is passed, it overrides the `1em` default —
   * useful for fixed-pixel chrome like the window controls.
   */
  size?: number
}

/**
 * Spreads the `size` prop onto `width`/`height` while keeping the SVG's
 * `1em` defaults in place when `size` is omitted. `width` and `height`
 * are passed as numbers so the SVG attribute serializer writes the
 * numeric form (matching the Window* icons) rather than `1em`.
 */
function withSize<P extends { size?: number }>(
  props: P
...
export function Twitch({ size, ...props }: IconProps) {
  const wh = withSize({ size })
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
...
export function YouTube({ size, ...props }: IconProps) {
  const wh = withSize({ size })
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
...
export function Socialize({ size, ...props }: IconProps) {
  const wh = withSize({ size })
  return (
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...wh} {...props}>
...
export function News({ size, ...props }: IconProps) {
  const wh = withSize({ size })
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...wh} {...props}>
    <g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}>
...
export function Leaderboard({ size, ...props }: IconProps) {
  const wh = withSize({ size })
  return (
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...wh} {...props}>
...
export function DiscordFilled({ size, ...props }: IconProps) {
  const wh = withSize({ size })
  return (
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...wh} {...props}>
...
export function Mail({ size, ...props }: IconProps) {
  const wh = withSize({ size })
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36" {...wh} {...props}>
...
export function Box({ size, ...props }: IconProps) {
    const wh = withSize({ size })
    return (
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" {...wh} {...props}>
...
export function Rewind10({ size, ...props }: IconProps) {
  const wh = withSize({ size })
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
...
export function Forward10({ size, ...props }: IconProps) {
  const wh = withSize({ size })
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
...
export function Cancel({ size, ...props }: IconProps) {
  const wh = withSize({ size })
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
