...
export function WineSection() {
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="sticky bottom-0 -mx-6 -mb-6 flex justify-end border-t border-border bg-background/95 p-4 backdrop-blur">
        <Button type="button" variant="gradient" onClick={() => void save()} disabled={saving || !dirty}>
